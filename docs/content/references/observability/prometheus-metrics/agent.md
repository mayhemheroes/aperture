...
| incoming_work_seconds_total | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_index                 | seconds              | A counter measuring work incoming into Scheduler |
| accepted_work_seconds_total | Counter | agent_group, instance, job, process_uuid, policy_name, policy_hash, component_index                 | seconds              | A counter measuring work admitted by Scheduler |
